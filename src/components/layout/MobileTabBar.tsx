...
export function MobileTabBar() {
  ...
  return (
    <TourStep id="nav" className="fixed inset-x-0 bottom-0 z-40 md:hidden">
      <nav className="border-t border-clw-gold/10 bg-clw-black/95 pb-[env(safe-area-inset-bottom)] backdrop-blur-md">
        <ul className="flex">
          {TABS.map((tab) => {
