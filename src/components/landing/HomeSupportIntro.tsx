...
export function HomeSupportIntro() {
  return (
    <section className="relative overflow-hidden border-b border-clw-gold/30 bg-clw-black px-5 pt-14 pb-28 text-clw-white sm:px-8 sm:pt-16 sm:pb-32 lg:px-12 lg:pt-20 lg:pb-36 xl:px-16 2xl:px-20">
