...
export function ProgramStructure() {
  return (
    <section className="relative isolate overflow-hidden border-y border-clw-gold/25 bg-clw-black px-5 py-14 text-clw-white sm:px-8 sm:py-16 lg:px-12 lg:py-14 xl:px-16 2xl:px-20 2xl:py-20">
      ...
      <span
        aria-hidden
        className="pointer-events-none absolute -bottom-10 -right-8 select-none font-display text-[12rem] leading-none text-clw-gold/[0.045] sm:text-[16rem] lg:text-[18rem] 2xl:text-[22rem]"
      >
        W
      </span>
      ...
      <div className="relative mx-auto max-w-4xl lg:max-w-6xl lg:text-center">
        <div>
          ...
          <h2 className="mt-4 max-w-3xl uppercase leading-[0.96] text-clw-white lg:mx-auto lg:max-w-none">
            <span className="block font-cond text-[clamp(3rem,12vw,5rem)] font-light tracking-[-0.015em] text-clw-white [word-spacing:0.08em] lg:text-[3.8rem] xl:text-[4.25rem] 2xl:text-[5rem]">
              Grouped to develop.
            </span>
            <span className="block font-display text-[clamp(2.8rem,11.5vw,5.15rem)] font-black tracking-[0.012em] text-clw-gold [word-spacing:0.1em] lg:text-[3.9rem] xl:text-[4.4rem] 2xl:text-[5.15rem]">
              Trained to compete.
            </span>
          </h2>
          ...
          <Link href="/program" className="mt-6 inline-block font-cond text-xl uppercase tracking-[0.18em] text-clw-gold underline-offset-4 hover:text-clw-gold-l hover:underline">
            Explore the program →
          </Link>
        </div>
      </div>
