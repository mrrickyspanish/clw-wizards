...
export function WhyCLW() {
  return (
    <div className="chamfer-md flex h-full flex-col border border-black/10 bg-white p-7 shadow-xl shadow-black/5">
      <h2 className="font-display text-5xl uppercase leading-none tracking-wide text-clw-ink">Why CLW</h2>
      ...
      <p className="mt-6 border-t border-black/10 pt-6 text-lg leading-relaxed text-clw-muted-dark">Families register, manage wrestlers, and handle dues from one parent portal.</p>
    </div>
  )
}
