...
export async function ProgramIntro() {
  ...
  return (
    <section className="section-light relative border-b border-clw-gold/35 bg-[#F7F7F7] px-5 pb-12 pt-8 sm:px-8 sm:pb-16 sm:pt-12 lg:px-12 lg:pb-16 lg:pt-16 xl:px-16 2xl:px-20">
